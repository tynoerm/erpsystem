            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-3">
                ...
                <input
                  ...
                  value={vendor_contactdetails}
                  onChange={(event) => setVendorcontactdetails(event.target.value)}
                />
              </div>
              <div className="mb-3">
              ...
              <tr key={index}>
                ...
                <td>
                  <Button
                    ...
                    onClick={() => handleShow1(accountspayables)}
                  >
                    Edit
                  </Button>
                  <button
                    className="btn btn-danger"
                    onClick={() => handleDelete(accountspayables._id)}
                  >
                    Delete
                  </button>
                </td>
